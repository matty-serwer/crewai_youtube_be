...
class CompanyResearchAgents():
    ...
    def research_manager(self, companies: list[str], positions: list[str]) -> Agent:
        return Agent(
            ...
            goal=f"""Generate a list of JSON objects containing the urls for 3 recent blog articles
                and the url and title for 3 recent Youtube interviews, for each position in each company.
                ...
                - If you can't find information from a specific position, fill in the information with the word "MISSING".
                ...
                """,
            backstory="""As a Company Research Manager, you are responsible for aggregating all the researched 
    ...
    def company_research_agent(self) -> Agent:
        return Agent(
            ...
            goal="""Look up the specific positions for a given company and find urls for 3 recent blog articles and the url 
            and title for 3 recent YouTube interviews for each person in the specified positions. It is your job to return this 
